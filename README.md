...
- **Client Version Integrity:** Client requests are tagged with a version header. Outdated clients are instantly hijacked at the leaderboard screen with an override payload, requiring players to pull the latest updates.
